            ...
            <div class="container-fluid rounded shadow" style="background: #f7fdfc;position: relative; height: 82vh;overflow-y:scroll" id="konten">
                <div class="row pt-3 pl-3 pr-3">
                    <div class="col-md-3 text-left">
                        ...
                        <a href="<?php echo base_url('pa/formPerformance/'.$this->uri->segment(3));?>" class="btn btn-sm btn-secondary" onclick="loader()"><i class="fas fa-sync"></i></a>
                    ...
                    <div class="col-md-6"><h4>LIST FORM PERFORMANCE APPRAISAL</h4></div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #000;">
                                    <a href="<?php echo base_url('pa/lihatFormulirr/'.$header->kode_pa)?>" class="btn <?php if($header->status == "PROCESS" || $header->status == "CONFIRMED"){echo "btn-success";}else{echo "btn-secondary";} ?> btn-xs">D</a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control form-control-sm" name="jenis" value="<?= $nama_jenis?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3">
