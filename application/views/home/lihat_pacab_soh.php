            ...
            <div class="container-fluid rounded shadow" style="background: #f7fdfc;position: relative; height: 82vh;overflow-y:scroll" id="konten">
                <div class="row pt-3 pl-3 pr-3">
                    ...
                    <a href="javascript: history.go(-1)" class="btn btn-sm btn-secondary" onclick="loader()"><i class="fas fa-chevron-left"></i> Kembali</a>&ensp;
                        <a href="<?php echo base_url('pa/formPerformanceSOH/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>" class="btn btn-sm btn-secondary" onclick="loader()"><i class="fas fa-sync"></i></a>
                ...
                <div class="row pt-3 pl-3 pr-3">
                    ...
                    <div class="col-md-6">
                        <!-- <form method="GET" action="<?php echo base_url('pa/formPerformanceSOH/'.$this->uri->segment(2))?>" target="_blank" name="cari">
                                ...
                                <div class="col-md-5">
                                    <select class="form-control form-control-md" id="cabang"name="cabang">
                                        ...
                                        <?php foreach($cabang as $d){?>
                                            <option value="<?php echo $d->cabang;?> <?php if($d->cabang == $cabs){echo "selected";}?>"><?php echo $d->cabang.'-'.$d->nama_cab;?></option>
                                        <?php }?>
                                    </select>
                                    </div>  
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #000;">
                                    <a href="<?php echo base_url('pa/lihatFormulirr/'.$header->kode_pa)?>" class="btn btn-secondary btn-xs">D</a>
