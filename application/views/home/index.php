    ...
    <div class="wrapper">
        ...
        <div id="content" class="content text-center" style="">
                    ...
                    <table class="table table-bordered table-hover table-sm shadow" id="table" style="border: 2px solid !important; font-size: 12px">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-nobby text-light" style="width: 8%; border: 1px solid #000;">KODE JENIS <i class="fas fa-sort"></i></th>                                
                                <th class="bg-nobby text-light" style="width: 8%; border: 1px solid #000;"> DESKRIPSI <i class="fas fa-sort"></i></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #000;"><?php echo $header->kd_jenis;?></td>
                                
                            <!-- Modal Karyawan-->
                            <div class="modal fade" id="modal-karyawan<?= $header->kd_jenis?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <!-- End Modal Karyawan-->
                                <td style="border: 1px solid #000;"><?php echo $header->tujuan;?></td>
                                <td style="border: 1px solid #000;">
                                <!-- <a href="<?php echo base_url('pa/editFormPerfomance/'.$header->kd_jenis)?>" class="btn btn-xs btn-secondary">E</a> -->
                                <?php if($this->session->userdata('level') == '240' || $this->session->userdata('level') == "210"){?>
                                    <a href="" data-toggle="modal" data-target="#modal-karyawan<?= $header->kd_jenis?>" class="btn btn-xs btn-success">+</a>
                                ...
                                <?php if( $this->session->userdata('level') == '130' AND $this->session->userdata('cabang') == "NH000" AND $this->session->userdata('dept') == '600'){?>
                                    ...
                                    <a href="<?php echo base_url('pa/cabangSOH/'.$header->kd_jenis)?>" class="btn btn-xs btn-secondary">D</a> 
                                <?php } ?>
                                <?php if($this->session->userdata('dept') == 'A10' || $this->session->userdata('dept') == 'A00'){?>
                                    <!-- <a href="<?php echo base_url('pa/formPerformanceHRD/'.$header->kd_jenis)?>" class="btn btn-xs btn-secondary">D</a> -->
                                    <a href="<?php echo base_url('pa/cabangHRD/'.$header->kd_jenis)?>" class="btn btn-xs btn-secondary">D</a>
                                <?php } ?>
            ...
            <div align="center" id="footer">
                <font style="color: white;">V.2206.02</font>
            </div>
        </div>
            ...
            <div class="table-responsive rounded pl-3 pr-3 pt-2">
                <form action="<?php echo base_url('pa/simpanPesertaJenis');?>"  method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-4">
                            <input required type="text" name="cabang" value="<?= $this->user->session('cabang')?>">
