        ...
        <div id="content" class="content text-center" style="">
            ...
            <div class="container-fluid rounded shadow" style="background: #fcfbfc;position: relative; height: 82vh;overflow-y:scroll" id="konten">
                <div class="row pt-3 pl-3 pr-3">
                    ...
                    <div class="col-md-6"><h4>LIST FORM PA & KPI KARYAWAN CABANG</h4></div>
                ...
                <div class="col-md-12 text-left rounded pl-3 pr-3 pt-2" style="font-size:14px;">
                    <form method="POST" action="<?php echo base_url('pa/lihatAllKaryawanKPI');?>">
                            <?php
                    ...
                    <table class="table table-bordered table-hover table-sm shadow" id="table" style="border: 2px solid !important; font-size: 12px">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-nobby text-light" style="width: 8%; border: 1px solid #000;">DEPT <i class="fas fa-sort"></i></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #000;">
                                    ...
                                    ?>
                                    <a href="<?php echo base_url('pa/lihatDetailKaryawanKPI/'.$header->kode_pa)?>" class="btn btn-xs <?php if($header->status == 'CONFIRMED'){ echo 'btn-success'; }else{ echo 'btn-secondary'; }?>" data-placement="bottom">D</a>

                                    <a href="<?php echo base_url('pa/lampiranPA/'.$header->kode_pa)?>" target="_blank" class="btn btn-sm btn-link" data-placement="bottom" title="Lihat file KPI"><i class="fa fa-file"></i></a>

                                    <?php if($auth == 'A' OR $auth =='R'){?>
                                    <a href="javascript:;" data-toggle="modal" data-placement="bottom" title="INPUT NILAI KPI" data-target="#nilai-kpi<?php echo $header->kode_pa?>" class="btn btn-xs btn-success">KPI</a>
                                    <?php }?>
                                </td>
                            </tr>

                                <!-- Modal Nilai KPI-->
                                <div class="modal fade" id="nilai-kpi<?php echo $header->kode_pa?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header bg-nobby">
                                                <h5 class="modal-title text-light" id="exampleModalLabel">INPUT NILAI KPI</h5>
                                                <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                        <form method="POST" action="<?php echo base_url('pa/simpanNilaiKPI');?>"> 
                                                <div class="modal-body">
                                                    <div class="form-group row">
                                                        <div class="col-md-3">
                                                            <label>Nilai KPI</label>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <input type="hidden" name="kode_pa" value="<?php echo $header->kode_pa?>">
                                                            <input type="hidden" name="nik" value="<?php echo $header->nik?>">
                                                            <input type="number" class="form-control form-control-sm" name="nilai_kpi">
                                                        </div>
                                                    </div>
                                                </div>
