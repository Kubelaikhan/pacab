        ...
        <div id="content" class="content text-center" style="">
            ...
            <div class="container-fluid rounded shadow" style="background: #fcfbfc;position: relative; height: 82vh;overflow-y:scroll" id="konten">
                ...
                <div class="col-md-12 text-left rounded pl-3 pr-3 pt-2" style="font-size:14px;">
                    <form method="POST" action="<?php echo base_url('pa/lihatAllKaryawan2');?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #000;">
                                    ...
                                    ?>
                                    <a href="<?php echo base_url('pa/lihatDetailKaryawan2/'.$header->kode_pa)?>" class="btn btn-xs <?php if(($header->status == 'ACCEPTED') OR $header->status =='PROCESS' && $header->user_input == $this->session->userdata('nik')){ echo 'btn-success'; }else{ echo 'btn-secondary'; }?>" data-placement="bottom">D</a>
                                </td>
                            </tr>
                            <?php }
                            } ?>
