            ...
            <div class="container-fluid rounded shadow" style="background: #fcfbfc;position: relative; height: 82vh;overflow-y:scroll" id="konten">
                <div class="row pt-3 pl-3 pr-3">
                    ...
                    <!-- <a href="javascript: history.go(-1)" class="btn btn-sm btn-secondary" onclick="loader()"><i class="fas fa-chevron-left"></i> Kembali</a>&ensp; -->
                        <a href="<?php echo base_url('pa/lihatBawahanByHead2/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>" class="btn btn-sm btn-secondary" onclick="loader()"><i class="fas fa-sync"></i></a>
                    </div>
                    <div class="col-md-6"><h4>LIST FORM PA CABANG</h4></div>
                ...
                <div class="col-md-12 text-left rounded pl-3 pr-3 pt-2" style="font-size:14px;">
                    <form method="POST" action="<?php echo base_url('pa/lihatBawahanByHead2/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>">
                ...
                <div class="table-responsive rounded pl-3 pr-3 pt-2">
                    <table class="table table-bordered table-hover table-sm shadow" id="table" style="border: 2px solid !important; font-size: 12px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="left" style="border: 1px solid #000;"><?php echo $header->nama?></td>
                                ...
                                <td style="border: 1px solid #000;">
                                    ...
                                    <?php if($header->jabatan =="SUPERVISOR STORE"){?>
                                        <a href="<?php echo base_url('pa/lihatDetailBawahan/'.$header->kode_pa)?>" class="btn btn-xs <?php if($isi == $jml AND ($header->status == 'PROCESS' OR $header->status =='AGREE') AND ($header->user_input == $header->nik OR $header->user_input == $this->session->userdata('nik'))){ echo 'btn-success'; }else{ echo 'btn-secondary'; }?>" data-placement="bottom">D</a>
                                    <?php } ?>
                                    <?php if($header->jabatan != "SUPERVISOR STORE"){ ?>
                                        <a href="<?php echo base_url('pa/lihatDetailBawahanDept/'.$header->kode_pa)?>" class="btn btn-xs <?php if($isi == $jml AND ($header->status == 'PROCESS' OR $header->status =='AGREE') AND ($header->user_input == $header->nik OR $header->user_input == $this->session->userdata('nik'))){ echo 'btn-success'; }else{ echo 'btn-secondary'; }?>" data-placement="bottom">D</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php }
                    ...
                    <!-- <div class="text-right pl-3 pr-4 pt-2" style="border: 1px; font-size:12px;">
                        <tr>
                            <th>Keterangan : &nbsp;&nbsp;</th>
                            <th>&nbsp;<a href="" class="btn btn-xs btn-warning"></a> Data Belum Lengkap&nbsp;</th>
