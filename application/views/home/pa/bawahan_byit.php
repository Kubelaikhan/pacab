            ...
            <div class="container-fluid rounded shadow" style="background: #fcfbfc;position: relative; height: 82vh;overflow-y:scroll" id="konten">
                <div class="row pt-3 pl-3 pr-3">
                    <div class="col-md-3 text-left">
                        <a href="<?php echo base_url('pa/lihatBawahanByIT');?>" class="btn btn-sm btn-secondary" onclick="loader()"><i class="fas fa-sync"></i></a>
                    </div>
                    <div class="col-md-6"><h4>LIST FORM PA BAWAHAN ALL KARYAWAN</h4></div>
                ...
                <div class="col-md-12 text-left rounded pl-3 pr-3 pt-2" style="font-size:14px;">
                    <form method="POST" action="<?php echo base_url('pa/lihatBawahanByIT');?>">
                    ...
                    <table class="table table-bordered table-hover table-sm shadow" id="table" style="border: 2px solid !important; font-size: 12px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid #000;"><?php echo $header->departemen;?></td>
                                ...
                                <td style="border: 1px solid #000;">
                                    ...
                                    ?>
                                    <a href="<?php echo base_url('pa/lihatDetailBawahan/'.$header->kode_pa)?>" class="btn btn-xs <?php if($isi == $jml AND $header->status == 'PROCESS'){ echo 'btn-success'; }elseif($isi != $jml AND $header->status == 'PROCESS'){ echo 'btn-warning text-light'; }else{ echo 'btn-secondary'; }?>" data-placement="bottom">D</a>
                                </td>
                            </tr>
                            <?php }
                            } ?>
